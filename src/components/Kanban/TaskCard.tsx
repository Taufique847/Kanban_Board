          ...
          {!isCompleted && (
            <div className="px-4 py-3 border-t border-slate-100 flex items-center gap-2">
              <button
                ...
                className="bg-[#2e74da] hover:bg-[#2060c0] text-white text-xs font-semibold px-4 py-1.5 rounded"
              >
                Edit
              </button>
              <button
                onClick={(e) => { e.stopPropagation(); onDelete(task); }}
                className="bg-[#da4f50] hover:bg-[#c23e3e] text-white text-xs font-semibold px-4 py-1.5 rounded"
              >
                Delete
              </button>
              <button
                onClick={(e) => { e.stopPropagation(); onMove(task); }}
                className="bg-[#e2e8f0] hover:bg-[#cbd5e1] text-slate-700 text-xs font-semibold px-3 py-1.5 rounded flex items-center gap-1 ml-auto"
              >
